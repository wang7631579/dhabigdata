...
@Configuration
@MapperScan(basePackages = "com.dha.dhabigdata.mapper.otherdb", sqlSessionTemplateRef = "db2SqlSessionTemplate")
public class DataSourceOtherConfig {
	...
	public SqlSessionFactory db2SqlSessionFactory(@Qualifier("db2DataSource") DataSource dataSource) throws Exception {
		...
		bean.setMapperLocations(
				new PathMatchingResourcePatternResolver().getResources("classpath:mybatis/mapper/other/*.xml"));
